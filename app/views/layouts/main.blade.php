...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div id="wrapper">
            <header>
                <section id="top-area">
                    <p>Phone orders: 1-800-0000 | Email us: <a href="">gizmo@office.com</a></p>
                </section><!-- end top-area -->
                <section id="action-bar">
                    <div id="logo">
                        <a href="/"><span id="logo-accent">G</span>izmo</a>
                    </div><!-- end logo -->
                            ...
                            <li>
                                ...
                                <ul>
                                    @if(count($catnav) > 0)
                                        ...
                                        @endforeach
                                    @else
                                        <li class="empty-result">No Category Results</li>
                                    @endif
                                </ul>
                            </li>
                        </ul>
                    ...
                    <div id="user-menu">
                            ...
                            <nav class="dropdown">
                                <ul>
                                    <li>
                                        ...
                                        <ul>
                                            <li>{{ HTML::link('users/accountinfo/' . Auth::user()->id , 'Account') }}</li>
                        ...
                        @else
                            ...
                            <div id="view-cart">
                                <a href="{{ url('cart/index') }}">{{ HTML::image('img/blue-cart.gif', 'View Cart') }} View Cart</a>
                            </div><!-- end view-cart -->
                        @endif
                    ...
                    @if(Auth::check())
                        @if(Auth::user()->admin == 1)
                            <nav class="dropdown">
                                <ul>
                                    <li>
                                        <a href="#">Transactions {{ HTML::image('img/down-arrow.gif', 'Transactions') }}</a>
                                        <ul>
                                            <li>{{ HTML::link('', 'Order History') }}</li>
                                            <li>{{ HTML::link('', 'Manage Users') }}</li>
            ...
            <footer>
                <section id="contact">
                    <h3>For phone orders please call 1-800-000. You<br>can also email us at <a href="">gizmo@office.com</a></h3>
                </section><!-- end contact -->
                ...
                <section class="clearfix">
                    <div id="copyright">
                        ...
                        <p id="store-desc">A online store that sells new innovations.</p>
                        <p id="store-copy">&copy; 2016 Gizmo. Theme designed by Adi Purdila.</p>
                    </div><!-- end copyright -->
                    <div id="connect">
